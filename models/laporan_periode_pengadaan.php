...
// Umum
$sqltahunterawal = 'SELECT MIN(tgl_pengadaan) AS tahun_terawal FROM t_pengadaan_fasilitas
                    WHERE status_pengadaan = "Baik" LIMIT 1';
...
<body>
    ...
    <div class="main-content" id="clientPrintContent">
        ...
        <main>
            ...
            <div class="print-hide">
                <h3><span>Laporan Pengadaan Fasilitas</span></h3>
                <small>
                    <i class="nav-icon text-info fas fa-info-circle"></i> 
                    Daftar laporan pengadaan fasilitas yang sudah dibuat
                </small>
            </div>
    ...
    <script>
        ...
        function savePDF(){
            ...
            var opt = {
                margin:       [1.5,2,2,2],
                filename:     `Laporan-Pengadaan_Periode-${periode_laporan}_Diunduh-Pada${dateTime}.pdf`,
