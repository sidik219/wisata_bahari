...
if (isset($_POST['submit'])) {
    ...
    $sqlpaketUpdate = "UPDATE t_fasilitas_wisata
    ...
    if ($affectedrows == '0') {
        // header("Location: edit_data_fasilitas_wisata?status=updateGagal");
    } else {
        header("Location: view_kelola_fasilitas_wisata?status=updateBerhasil");
    }
}
?>
                            ...
                            <div class="table-portable">
                                <form action="#" method="POST" enctype="multipart/form-data">
                                    <div class="kelola-detail">
                                        <!-- Hiidden Wisata -->
                                        <div class="input-box">
                                            <input type="hidden" name="id_wisata" value="<?=$rowFasilitas->id_wisata?>" placeholder="Id Wisata" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="details">Nama Fasilitas</span>
                                            <input type="text" name="nama_fasilitas" value="<?=$rowFasilitas->nama_fasilitas?>" placeholder="Nama Fasilitas" required>
                                        </div>
                                        <div class="input-box">
                                            <span class="details">Biaya Fasilitas</span>
                                            <input type="text" name="biaya_fasilitas" value="<?=$rowFasilitas->biaya_fasilitas?>" placeholder="Biaya Fasilitas" required>
                                        </div>
                                    </div>
