...
// Umum
$sqltahunterawal = 'SELECT MIN(tgl_kontrak_asuransi) AS tahun_terawal FROM t_paket_wisata
...
<body>
    ...
    <div class="main-content" id="clientPrintContent">
        ...
        <main>
            ...
            <div class="print-hide">
                <h3><span>Laporan Asuransi</span></h3>
                <small>
                    <i class="nav-icon text-info fas fa-info-circle"></i> 
                    Daftar laporan asuransi yang sudah dibuat
                </small>
            </div>
    ...
    <script>
        ...
        function savePDF(){
            ...
            var opt = {
                margin:       [1.5,2,2,2],
                filename:     `Laporan-Asuransi_Periode-${periode_laporan}_Diunduh-Pada${dateTime}.pdf`,
