  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg fixed-top py-3 backdrop" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#"> <img class="d-inline-block align-top img-fluid" src="assets/img/gallery/logo-icon.png" alt="" width="50" /><span class="text-primary fs-4 ps-2">Wisata Bahari</span></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
              ...
              <li class="nav-item"><a class="nav-link text-600" href="#places">Info Wisata</a></li>
              <li class="nav-item"><a class="nav-link text-600" href="#booking">Kontak Kami</a></li>
            </ul>
            <form class="ps-lg-5">
              <a href="models/login.php" class="btn btn-lg btn-outline-primary order-0" type="submit">Login</a>
            </form>
          </div>
        </div>
      </nav>
        ...
        <div class="container position-relative">
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div class="col-md-7 col-lg-6 text-center text-md-start py-8">
              <h1 class="mb-4 display-1 lh-sm">Wisata Bahari <br class="d-block d-lg-none d-xl-block" />Pantai Tangkolak</h1>
              <p class="mt-4 mb-5 fs-1 lh-base">Kabupaten Karawang di perairan tangkolak dikenal sebagai <br class="d-none d-lg-block" /> kuburan kapal-kapal dagang dari Hindia Belanda VOC yang tenggelam ratusan lalu. <br class="d-none d-lg-block" />Pemerintah menjadikan tempat tersebut sebagai bagian dari pengembangan wisata bahari.</p><a class="btn btn-lg btn-primary hover-top" href="models/login.php" role="button">Login Sekarang</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row flex-md-center">
            <div class="col-md-11 col-lg-4 py-md-3 px-4 px-md-3 px-lg-0 px-xl-2 order-lg-1">
              <h1 class="fw-bold fs-md-3 fs-xl-5">Paket Wisata</h1>
              <hr class="text-primary my-4 my-lg-3 my-xl-4" style="height:3px; width:70px;" />
              <p class="lh-lg">Pantai tangkolak memiliki berbagai macam paket wisata yang dapat dipilih oleh wisatawan ketika akan melakukan reservasi wisata.</p><a class="btn btn-lg btn-primary hover-top" href="#" role="button">Explore</a>
            </div>
                  ...
                  <div class="carousel-item active">
                    <div class="row h-100">
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/gallery/p1.png" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"><span class="badge bg-primary">Rp. 450,000</span></div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                              <h5 class="text-white">Paket Wisata Snorkling</h5>
                              <!-- <h6 class="text-600">28 Februari 2022</h6> -->
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/gallery/p2.png" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"><span class="badge bg-primary">Rp. 450,000</span></div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                              <h5 class="text-white">Paket Wisata Snorkling Indah</h5>
                              <!-- <h6 class="text-600">26 Februari 2022</h6> -->
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="assets/img/gallery/p3.png" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"><span class="badge bg-primary">Rp. 6,450,000</span></div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                              <h5 class="text-white">Paket Wisata Snorkeling & Diving</h5>
                              <!-- <h6 class="text-600">01 Maret 2022</h6> -->
                            </div>
                          </div>
                        </div>
                      </div>
        ...
        <div class="container">
          <div class="row flex-center mb-5">
            <div class="col-lg-8 text-center">
              <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5">Footage Wisata Bahari</h1>
                    ...
                    <div class="carousel-indicators">
                      <div class="row h-100 w-100">
                        <div class="col-12 px-1">
                          <button class="active" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1"><img class="d-block" src="assets/img/gallery/footage.png" alt="..." /></button>
                        </div>
                        <div class="col-12 px-1">
                          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2"><img class="d-block" src="assets/img/gallery/maldives-v.png" alt="..." /></button>
                        </div>
                        <div class="col-12 px-1">
                          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 2"><img class="d-block" src="assets/img/gallery/tanzania.png" alt="..." /></button>
                        </div>
                        <div class="col-12 px-1">
                          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="3" aria-label="Slide 3"><img class="d-block" src="assets/img/gallery/kathmandu-v.png" alt="..." /></button>
                        </div>
                        <div class="col-12 px-1">
                          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="4" aria-label="Slide 4"><img class="d-block" src="assets/img/gallery/chaina.png" alt="..." /></button>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      <div class="col-12 col-md-11 col-lg-12 col-xl-10 col-xxl-7 px-xxl-0 ps-lg-0 ps-md-4">
                        <div class="card h-100 py-md-2 active" style="min-height:113px">
                          <div class="card-body d-flex flex-column justify-content-center">
                            <p class="mb-0 fw-semi-bold text-dark"> Footage Wisata Bahari Pantai Tangkolak</p>
                            <p class="card-text"><small class="text-800">02.00</small></p>
                          </div>
                        </div>
                      </div>
                      <div class="col-12 col-md-11 col-lg-12 col-xl-10 col-xxl-7 px-xxl-0 ps-lg-0 ps-md-4">
                        <div class="card h-100 py-md-2 active" style="min-height:113px">
                          <div class="card-body d-flex flex-column justify-content-center">
                            <p class="mb-0 fw-semi-bold text-dark"> Data Dummy When go to maldives</p>
                      ...
                      <div class="col-12 col-md-11 col-lg-12 col-xl-10 col-xxl-7 px-xxl-0 ps-lg-0 ps-md-4">
                        <div class="card h-100 py-md-2" style="min-height:113px">
                          <div class="card-body d-flex flex-column justify-content-center">
                            <p class="mb-0 fw-semi-bold text-500"> Data Dummy Tanzania’s deadly pink lake</p>
                      ...
                      <div class="col-12 col-md-11 col-lg-12 col-xl-10 col-xxl-7 px-xxl-0 ps-lg-0 ps-md-4">
                        <div class="card h-100 py-md-2" style="min-height:113px">
                          <div class="card-body d-flex flex-column justify-content-center">
                            <p class="mb-0 fw-semi-bold text-500"> Data Dummy Top things to do in Kathmandu</p>
                      ...
                      <div class="col-12 col-md-11 col-lg-12 col-xl-10 col-xxl-7 px-xxl-0 ps-lg-0 ps-md-4">
                        <div class="card h-100 py-md-3" style="min-height:113px">
                          <div class="card-body d-flex flex-column justify-content-center">
                            <p class="mb-0 fw-semi-bold text-500"> Data Dummy Exploring China’s creative capital</p>
                            <p class="card-text"><small class="text-800">0.20 </small></p>
                          </div>
                        </div>
                      </div>
      ...
      <section class="pt-5">
        ...
        <div class="container">
          <div class="row flex-center mb-5">
            <div class="col-lg-8 text-center">
              <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5">Jenis Wisata</h1>
              <hr class="mx-auto text-primary my-4" style="height:3px; width:70px;" />
              <p class="mx-auto">Pantai tangkolak memiliki berbagai macam jenis wisata yang dapat dinikmati oleh wisatawan.</p>
            </div>
          </div>
                    ...
                    <div class="carousel-item active" data-bs-interval="10000">
                      <div class="row h-100">
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="!#"><img class="img-fluid" src="assets/img/gallery/w1.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Snorkeling Terumbu Karang A</h5>
                            </div>
                          </div>
                        </div>
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="!#"><img class="img-fluid" src="assets/img/gallery/w2.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Snorkeling Terumbu Karang B</h5>
                            </div>
                          </div>
                        </div>
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="!#"><img class="img-fluid" src="assets/img/gallery/w3.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Snorkeling Terumbu Karang C</h5>
                            </div>
                          </div>
                        </div>
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white"><a class="stretched-link" href="!#"><img class="img-fluid" src="assets/img/gallery/w4.jpg" alt="" /></a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                              <h5 class="text-white fs--1">Diving</h5>
                            </div>
                          </div>
                        </div>
                        <!-- <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
      ...
      <!-- <section class="pt-5">
        ...
        <div class="container">
          <div class="row flex-center mb-5">
            <div class="col-lg-8 text-center">
              <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5">Testimoni Wisatawan</h1>
              <hr class="mx-auto text-primary my-4" style="height:3px; width:70px;" />
            </div>
          ...
          <div class="row">
            <div class="col-12 py-8 text-white">
              <div class="d-flex flex-column flex-center">
                <h2 class="text-white fs-2 fs-md-3">KONTAK KAMI</h2>
              ...
              <form class="row gy-2 gx-md-2 gx-lg-4 flex-center my-6">
                <div class="col-6 col-md-3">
                  <label class="visually-hidden" for="inlineFormSelectPref">Nama</label>
                ...
                <div class="col-6 col-md-3">
                  <label class="visually-hidden" for="autoSizingSelect">Alamat</label>
                  <input class="form-control" type="text" placeholder="Aamat">
            ...
            <div class="col-auto mb-4">
              <ul class="list-unstyled list-inline mb-0">
                <li class="list-inline-item me3 me-sm-4">
                  <a class="text-dark text-decoration-none" href="#!">Home</a></li>
                <!-- <li class="list-inline-item me3 me-sm-4">
                  <a class="text-dark text-decoration-none" href="#!">Video</a></li> -->
                <li class="list-inline-item me3 me-sm-4">
                  <a class="text-dark text-decoration-none" href="#places">Info Wisata</a></li>
                <li class="list-inline-item me3 me-sm-4">
                  <a class="text-dark text-decoration-none" href="#booking">Kontak Kami</a></li>
                <!-- <li class="list-inline-item me3 me-sm-4">
                  <a class="text-dark text-decoration-none" href="#!">Contact</a></li>
                <li class="list-inline-item me3 me-sm-4">
                  <a class="text-dark text-decoration-none" href="#!">Pricing</a></li>
                <li class="list-inline-item me3 me-sm-4">
                  <a class="text-dark text-decoration-none" href="#!">Privacy Policy</a></li> -->
              </ul>
            </div>
          </div>
          <div class="row flex-center">
            <div class="col-auto mb-4">
              <p class="mb-0 fs--1 text-dark">&copy; 2021 Wisata Bahari&nbsp;
